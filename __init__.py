...
#env_instance = gym.make('OctopusArmLockedJointsClassifierForUnlockingJoints2DBulletEnv-v0', render=True, number_of_links_urdf=8, number_of_joints_urdf=8)
register(
    id='OctopusArmLockedJointsClassifierForUnlockingJoints2DBulletEnv-v0',
    entry_point='pybullet_envs.octopus_lockedjoints_classifier_env:OctopusEnv', # octopus_lockedjoints_classifier_env.py
    max_episode_steps=1000*100,
    reward_threshold=20000.0*1000,
)
