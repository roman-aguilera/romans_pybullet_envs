from .scene_stadium import SinglePlayerStadiumScene  #sdf plane file is loaded in ~/anaconda3/envs/roman_playful/lib/python3.6/site-packages/pybullet_envs/scene_stadium.py
